...
public class ResendEmployeeEmail extends DriverTestCase {
	@Test
	public void testLogin() throws Exception {
		...
		try {
			...
			// Click on Re-send email button
			ExecutionLog.Log("Click on Re-send email button");
			resendEmployeeEmailHelper.clickOnResendEmail(Employeename);
			ExecutionLog.Log("Passed");
			addEmployeeHelper.waitForWorkAroundTime(6000);
			
			// Click on confirmation popup
			resendEmployeeEmailHelper.acceptAlert();
			resendEmployeeEmailHelper.waitForWorkAroundTime(1000);
